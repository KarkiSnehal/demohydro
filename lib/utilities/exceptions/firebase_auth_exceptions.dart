///Custom exception class to handle various Firebase authenticatin-related errors.
  ...
  String get message {
    switch (code) {
      case 'email-already-in-use':
        return 'The email address is already registered. Pleaase use a different email.';
      case 'invalid-email':
        return 'The email address provided is invalid. Pleaase enter a valid email.';

      case 'weak-password':
        return 'The password is too weak. Pleaase choose a stronger password.';

      case 'user-disabled':
        return 'This account has been disabled. Pleaase contact support for assistance.';
